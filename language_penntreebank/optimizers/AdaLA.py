...
class AdaLA(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(AdaLA, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(AdaLA, self).__setstate__(state)
    ...
    def step(self, old_state=None, new_state=None, closure=None):
        ...
        for group_idx, group in enumerate(self.param_groups):
            for p_idx, p in enumerate(group['params']):
                if p.grad is None:
                    continue
                if old_state is not None and new_state is not None:
                    next_grad = new_state[group_idx]['params'][p_idx].grad.data
                grad = p.grad.data
                if grad.is_sparse:
